...
// ตรวจสอบสถานะของงาน ต้องเป็น 'awaiting_confirmation' เท่านั้น
if ($payment_info['status'] !== 'awaiting_confirmation') {
    // อาจจะ redirect ไปหน้า my_requests พร้อมข้อความแจ้งเตือน
...
<head>
    ...
    <style>
        * { font-family: 'Kanit', sans-serif; }
        body { background: linear-gradient(135deg, #f0f4f8 0%, #e8edf3 100%); }
        .payment-card {
            background: white;
    ...
    <main class="container mx-auto px-4 py-8 flex-grow">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="payment-card p-8">
                ...
                <div class="mb-8 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
                    <p class="font-bold"><i class="fa-solid fa-circle-info mr-2"></i>คำแนะนำ:</p>
                    <p>กรุณาโอนเงินไปยังช่องทางที่ได้ตกลงกับนักออกแบบไว้ผ่านทางระบบแชท จากนั้นแนบสลิปการโอนเงินเพื่อให้นักออกแบบตรวจสอบและเริ่มงานต่อไป</p>
                </div>
                ...
                <form action="submit_payment.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-8">
                        <button type="submit" class="w-full text-center px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold text-lg hover:bg-blue-700 transition-colors">
